...
```{r geom_statebins-not-found, eval=FALSE}
# Error: Error in geom_statebins(family = dviz.supp::dviz_font_family, lbl_size = 8/.pt,  : could not find function "geom_statebins"
