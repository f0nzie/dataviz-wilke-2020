...
```{r bayes-vs-ols, fig.width = 5*6/4.2, fig.asp = 0.6, fig.cap = '(ref:bayes-vs-ols)', eval=FALSE}
# Error: Error in model.frame.default(Terms, newdata, xlev = object$xlevels) : factor location has new levels US
...
```{r bayes-ridgeline, fig.width = 5*6/4.2, fig.asp = 0.6, fig.cap = '(ref:bayes-ridgeline)', eval=FALSE}
bayes_emmeans %>%
